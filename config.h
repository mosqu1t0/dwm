...
static const char *fonts[]          = { "JetBrainsMono Nerd Font Mono:style=Medium,Regular:size=12",
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_j,      rotatetags,     {.i = -1 } },
	{ MODKEY|ShiftMask,             XK_k,      rotatetags,     {.i = +1 } },
